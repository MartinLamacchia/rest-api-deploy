...
// /Todos los recursos que sean MOVIES se identificaran con /movies
...
app.post("/movies", (req, res) => {
  ...
  //  Se podria usar el error 422 tambien que significa que el servidor anda bien pero la sintaxis estaba mal
  if (result.error) {
